...
def main(output=True, logging=True, paxial = -450.0, nsteps_axial=40):
    ...
    print("last_sxx: %.15e" % last_sxx)
    print("last_syy: %.15e" % last_syy)
    print("last_szz: %.15e" % last_szz)
    print("last_Eur: %.15e" % last_Eur)
    print("last_pp: %.15e" % last_pp)
    # for node in model.model_part.Nodes:
...
def test():
    ...
    ## old test results on Hereon laptop
    # # last_ezz = -5.0881481400e-03
    # # ref_dezz = -2.3026087853e-02
    # ref_dezz = -2.3026303746e-02 # adjust due to change in MultiSurfaceElastoplasticityLaw, line 92-95

    ## test results on AMD laptop and with more stringent tolerance
    # ref_last_ezz = -5.088148240559876e-03
    # ref_dezz = -2.302623634226852e-02

    ## test results on Intel i9-13950HX laptop and with more stringent tolerance and single integration point
    ref_last_ezz = -5.088148240559875e-03
    ref_dezz = -2.302676752069640e-02
