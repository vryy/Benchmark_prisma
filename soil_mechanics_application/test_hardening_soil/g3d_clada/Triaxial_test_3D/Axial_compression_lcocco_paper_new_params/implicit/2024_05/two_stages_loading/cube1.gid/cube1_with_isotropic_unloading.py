...
def main(output=True, logging=True, paxial=-250.0, nsteps_axial=40):
...
def test():
    model = main(logging=False, output=False, paxial=-250.0, nsteps_axial=40)

    ###### pytesting results
    last_ezz = -6.3218865241e-03
    ref_dezz = -3.5522699688e-02
    elem = model.model_part.Elements[1]
    strain = elem.CalculateOnIntegrationPoints(STRAIN, model.model_part.ProcessInfo)
