def ReadLayerSets():
    ...
    layer_sets['loadx'] = layer_elements_list
    layer_elements_list = [
    ]
    layer_sets['loady'] = layer_elements_list
    layer_elements_list = [
    ]
    layer_sets['loadz'] = layer_elements_list
    return layer_sets
...
def ReadLayerNodesSets():
    ...
    layer_nodes_sets['loadx'] = layer_nodes_list
    layer_nodes_list = [
    ]
    layer_nodes_sets['loady'] = layer_nodes_list
    layer_nodes_list = [
    ]
    layer_nodes_sets['loadz'] = layer_nodes_list
