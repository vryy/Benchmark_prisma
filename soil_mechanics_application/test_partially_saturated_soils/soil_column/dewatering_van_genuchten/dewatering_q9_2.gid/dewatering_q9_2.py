...
##### all rights reserved                                    #####
##################################################################
## This file is generated on Tue Jan 13 07:21:26 PM GMT 2026
##################################################################
import sys
import os
import math
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        # main(logging=True, output=True, dt=10, num_steps=1, p=0.0, analysis_type=2, dissipation_radius=0.1)
        main(logging=True, output=False, dt=10, num_steps=720, p=0.0, analysis_type=1, dissipation_radius=0.9)
