...
class Model:
    ...
    def InitializeModel( self, sub_steps_range=30, viscous_damping=0.0, local_error_tolerance=1e-6 ):
        ##################################################################
        ## STORE LAYER SETS ##############################################
        ##################################################################
        ...
        self.model_part.Properties[1].SetValue(MAXIMUM_NUMBER_OF_SUB_STEPPING_LEVELS, sub_steps_range )
        ...
        self.model_part.Properties[2].SetValue(MAXIMUM_NUMBER_OF_SUB_STEPPING_LEVELS, sub_steps_range )
