...
class Model:
    ...
    def InitializeModel( self, number_of_sub_steps=30, viscous_damping=0.0 ):
        ##################################################################
        ## STORE LAYER SETS ##############################################
        ##################################################################
        ...
        self.model_part.Properties[1].SetValue(MAXIMUM_NUMBER_OF_SUB_STEPPING_LEVELS, number_of_sub_steps )
        ...
        self.model_part.Properties[2].SetValue(MAXIMUM_NUMBER_OF_SUB_STEPPING_LEVELS, number_of_sub_steps )
