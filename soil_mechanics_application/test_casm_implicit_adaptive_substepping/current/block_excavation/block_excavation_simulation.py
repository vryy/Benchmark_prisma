...
def test():
    test_with_params(number_of_excavation_layers_per_step=8, ref_uy=4.7052776036871150e-02)
    test_with_params(number_of_excavation_layers_per_step=4, ref_uy=4.2415739666736202e-02)
    test_with_params(number_of_excavation_layers_per_step=2, viscous_damping=1e-5, ref_uy=4.1518795538650531e-02)
    test_with_params(number_of_excavation_layers_per_step=1, ref_uy=4.1215955869073222e-02)
    print("Test passed")
