...
class Model:
    def __init__( self, problem_name, path, results_path, logging=True ):
        ...
        self.analysis_parameters['analysis_type'] = 4
        self.analysis_parameters['dissipation_radius'] = 1.
        ...
        self.analysis_parameters['number_of_iterations_for_divergence_check'] = 100
        self.analysis_parameters['convergence_criteria'] = "custom criteria"
        self.analysis_parameters['custom_convergence_criteria'] = PressureSaturationCriteria(self.rel_tol, self.abs_tol)
        ...
        self.model_part.AddNodalSolutionStepVariable( SATURATION )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_DT )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_DT2 )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_NULL )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_NULL_DT )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_NULL_DT2 )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_EINS )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_EINS_DT )
        self.model_part.AddNodalSolutionStepVariable( SATURATION_EINS_DT2 )
        ##################################################################
        ## READ MODELPART ################################################
        ##################################################################
        #reading a model
    ...
    def WriteOutput( self, time ):
        ...
        self.gid_io.WriteNodalResults(SATURATION, time, 0)
        print("nodal SATURATION written")
        self.gid_io.WriteNodalResults(AIR_PRESSURE, time, 0)
        ...
        self.gid_io.PrintOnGaussPoints(CAPILLARY_PRESSURE, self.model_part, time)
        print("gauss point CAPILLARY_PRESSURE written")
        self.gid_io.PrintOnGaussPoints(WATER_FLOW, self.model_part, time)
        print("gauss point WATER_FLOW written")
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      1.3e+06 )
        ...
        print("Linear elastic model selected for LinearElastic3D, description: Soil")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
