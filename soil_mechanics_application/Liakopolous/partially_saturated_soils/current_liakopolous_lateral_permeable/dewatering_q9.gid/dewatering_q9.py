...
##### all rights reserved                                    #####
##################################################################
## This file is generated on Wed Jan 14 10:50:37 AM GMT 2026
##################################################################
import sys
import os
import math
...
def main(output=True, logging=True, dt=1.0, num_steps=7200, p=0.0, analysis_type=1, dissipation_radius=0.1,apply_top_air_pressure=False):
...
def test():
    ...
    wf2 = wf[1]*60.0/0.01
    print("%.16e" % (wf2))
    ref_wf2 = -2.4921044964631472e-02 # for num_steps = 100 # same as result using h27 mesh
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        main(logging=True, output=False, p=0.0, apply_top_air_pressure=False)
