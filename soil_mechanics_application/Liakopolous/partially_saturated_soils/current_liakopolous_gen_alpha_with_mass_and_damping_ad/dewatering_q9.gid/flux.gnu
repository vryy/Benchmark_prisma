...
plot "../../../plotting/experiments/flux/FluxExp_time.txt" using 1:2 with points pt 5 ps 0.5 lt rgb "gray" title "Exp. (Liakopoulos 1965)", \
     ...
     "bottom_water_flow.log" using ($1/60):(-$2*60.0/0.01) with lines lw 1 lt rgb "blue" title "partially saturated soils model (lateral permeable) (saturation explicit)", \
     "../../../partially_saturated_soils/current_liakopolous_lateral_permeable/dewatering_q9.gid/bottom_water_flow.log" using ($1/60):(-$2*60.0/0.01) with lines lw 1 lt rgb "orange" title "partially saturated soils model (lateral permeable) (saturation implicit)", \
