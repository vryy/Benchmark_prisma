...
##################################################################
class Model:
    def __init__( self, problem_name, path, logging=True, material_type="smc-0" ):
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(COHESION,            490.0 )
        self.model_part.Properties[1].SetValue(ISOTROPIC_HARDENING_MODULUS,     0.0 )
        self.model_part.Properties[1].SetValue(APEX_CONTROL_PARAMETER,     0.0 )
        self.model_part.Properties[1].SetValue(TRANSITION_ANGLE,     1.0 )

        if self.material_type == "smc-0":
            self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, SmoothedMohrCoulombImplicitExplicitLodeAngle() )
            print("Smoothed Mohr Coulomb type 0 plasticity model selected")
        elif self.material_type == "smc-1":
            self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, SmoothedMohrCoulombImplicitExplicitLodeAngleC1() )
            print("Smoothed Mohr Coulomb type 1 plasticity model selected")
        elif self.material_type == "smc-2":
            self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, SmoothedMohrCoulombImplicitExplicitLodeAngleC2() )
            print("Smoothed Mohr Coulomb type 2 plasticity model selected")
