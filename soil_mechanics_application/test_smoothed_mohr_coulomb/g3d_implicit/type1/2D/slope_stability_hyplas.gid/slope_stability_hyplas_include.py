...
#                        #item.Free(AIR_PRESSURE)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(TRANSITION_ANGLE,     10.0 )
        self.model_part.Properties[1].SetValue(APEX_CONTROL_PARAMETER,     1.0 )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, SmoothedMohrCoulombG3dImplicitC1() )
        print("Smoothed Mohr Coulomb plasticity model selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
