...
#                        #item.Free(AIR_PRESSURE)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(TRANSITION_ANGLE,     30.0 )
        self.model_part.Properties[1].SetValue(APEX_CONTROL_PARAMETER,     0.1 )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, SmoothedMohrCoulombG3dImplicitC2() )
