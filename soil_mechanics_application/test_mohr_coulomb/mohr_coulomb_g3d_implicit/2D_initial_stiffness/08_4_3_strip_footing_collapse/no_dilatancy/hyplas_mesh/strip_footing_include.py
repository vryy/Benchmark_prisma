...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DILATANCY_ANGLE,            0.0 )
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, ElasticTangentConstitutiveLaw(MohrCoulombG3dImplicit()) )
