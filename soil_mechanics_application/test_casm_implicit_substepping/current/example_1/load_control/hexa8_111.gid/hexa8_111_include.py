...
#                        #item.Free(AIR_PRESSURE)
    ...
    def InitializeModel( self ):
        ...
        if self.material == "linear_elastic":
            ...
            print("CASM (implicit sub-stepping) is selected")
