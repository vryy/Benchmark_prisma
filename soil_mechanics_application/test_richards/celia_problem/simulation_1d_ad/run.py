...
def test():
    ...
    node = model.model_part.Nodes[27]
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        # main(logging=True, output=False, total_time=1.0, delta_time=1.0, analysis_type=2, dissipation_radius=0.9)
