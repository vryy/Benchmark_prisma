...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS, 2.1e7 )
        self.model_part.Properties[1].SetValue(POISSON_RATIO, 0.25 )
        self.model_part.Properties[1].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[1].SetValue(G_CONSTANT, 9.81 )
        self.model_part.Properties[1].SetValue(GRAVITY, [0.0, -9.81, 0.0] )
        ...
        print("Linear elastic material selected for Properties 1, description: PlaneStrain")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
