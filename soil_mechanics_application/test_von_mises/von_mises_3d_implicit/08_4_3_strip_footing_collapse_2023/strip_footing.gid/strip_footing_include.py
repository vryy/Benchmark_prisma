...
#        print("J2 (forward Euler) model selected, description: steel)"
            ...
            self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, VonMises3dImplicitExplicitRecast() )
        ...
        driver = SingleElementTestDriver(2)
        hlaw = LinearHardeningLaw(848.7, 0.0)
        driver.SetValue(ISOTROPIC_HARDENING_LAW, hlaw, self.model_part.Properties[1])
