...
class Model:
    ...
    def InitializeModel( self ):
        ...
        if self.material_type == "j2":
            self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, VonMisesG3dImplicit() )
        elif self.material_type == "j2-dc":
            self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, VonMisesG3dImplicitDC() )
