...
def main(output=True, logging=True, material_type="j2-implex-linearized-flow", ext_option=1, load_option=2):
...
def test():
    model = main(logging=False, output=False, material_type="j2-implex-linearized-flow", ext_option=1, load_option=2)
    ...
    ref_reac_scaled = 5.1933739232923308e+00
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        main(logging=True, output=False, material_type="j2-implex-linearized-flow", ext_option=2, load_option=3)
