...
class Model:
    def __init__( self, problem_name, path, logging=True ):
        ...
        self.analysis_parameters['residuum_tolerance'] = 1e-5
    ...
    def InitializeModel( self ):
        ...
        if self.material_type == "j2":
            self.model_part.Properties[1].SetValue(MAXIMUM_NUMBER_OF_SUB_STEPS, 2 )
            self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, ElasticTangentConstitutiveLaw(VonMisesG3dImplicitSubstepping()) )
            print("J2 (backward Euler, elastic tangent) model selected, description: steel")
