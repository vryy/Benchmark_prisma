...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DILATANCY_ANGLE,            10.0 )
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, DruckerPragerG3dImplicit_PlaneStrainMatchWithMohrCoulomb() )
        print("Drucker Prager (plane strain match) plasticity model selected")
