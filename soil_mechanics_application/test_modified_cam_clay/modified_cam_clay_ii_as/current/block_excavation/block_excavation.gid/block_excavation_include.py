...
##################################################################
class Model:
    def __init__( self, problem_name, path, results_path, logging=True, abs_tol=1e-10, rel_tol=1e-10 ):
    ...
    def InitializeModel( self, number_of_sub_steps=4, viscous_damping=0.0, local_error_tolerance=1e-8 ):
        ##################################################################
        ## STORE LAYER SETS ##############################################
        ##################################################################
