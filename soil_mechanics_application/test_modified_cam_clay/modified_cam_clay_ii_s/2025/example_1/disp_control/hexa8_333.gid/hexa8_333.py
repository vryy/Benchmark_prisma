...
##################################################################
##################################################################
## This file is generated on Sa 30. Mai 13:07:21 CEST 2020
##################################################################
import sys
import os
import math
...
##################################################################
##################################################################
import hexa8_333_include
from hexa8_333_include import *
##################################################################
###  SIMULATION  #################################################
...
def main(logging=True, output=True):
    ...
    model_insitu = hexa8_333_include.Model('hexa8_333',os.getcwd()+"/",os.getcwd()+"/",logging=False)
    ...
    ####  SYSTEM  #####################################################
    ###################################################################
    model = hexa8_333_include.Model('hexa8_333',os.getcwd()+"/",os.getcwd()+"/",logging=logging)
...
def test():
    ...
    q = pres['q'][0][0]
    pc = pres['pc'][0][0]
    ref_p = 3.3332320654006756e+05
    ref_q = 3.9996932949556818e+05
    ref_pc = 6.6661554986187548e+05
    print("p: %.16e" % p)
    print("q: %.16e" % q)
    print("pc: %.16e" % pc)
