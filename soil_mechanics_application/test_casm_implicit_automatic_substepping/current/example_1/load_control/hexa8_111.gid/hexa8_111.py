...
def main(output=True, logging=True, nsteps=266):
    ##################################################################
    ###  INSITU  #####################################################
    ##################################################################
    ...
    # delta_load_list = []
    # delta_loadq_list = []
    # for i in range(0, 255): # 259 #266
    #     delta_load_list.append(5.0e2)
    #     delta_loadq_list.append(15.0e2)
    # for i in range(0, 30):
    #     delta_load_list.append(5.0e1)
    #     delta_loadq_list.append(15.0e1)
    # for i in range(0, 700):
    #     delta_load_list.append(5.0)
    #     delta_loadq_list.append(15.0)
...
def test():
    ...
    model = main(output=False, logging=False, nsteps=266)
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        main(logging=True, output=False, nsteps=266)
