...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      1e8 )
        ...
        self.model_part.Properties[1].SetValue(COHESION,          15e3 )
        ...
        print("Matsuoka-Nakai model selected for bulk")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
