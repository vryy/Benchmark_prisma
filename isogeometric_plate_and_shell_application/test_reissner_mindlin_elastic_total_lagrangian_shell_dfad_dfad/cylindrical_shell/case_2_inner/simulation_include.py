...
class Model:
    ...
    def CreateModel(self, mpatch):
        ...
        element_name = "ReissnerMindlinElasticTotalLagrangianShellElementDFadDFadBezier2D3"
        # element_name = "ReissnerMindlinElasticTotalLagrangianShellElementBezier2D3"
