...
##################################################################
class Model:
    def __init__( self, problem_name, path, results_path, logging = False ):
    ...
    def WriteOutput( self, time ):
        ...
        self.gid_io.WriteNodalResults(ENTROPY, self.model_part.Nodes, time, 0)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      2.1e+011 )
        ...
        self.model_part.Properties[1].SetValue(THERMAL_CONDUCTIVITY, 45.0 ) # carbon-steel
        self.model_part.Properties[1].SetValue(THERMAL_EXPANSION, 13.0e-6 ) # mild steel
        self.model_part.Properties[1].SetValue(SPECIFIC_HEAT_CAPACITY, 0.0 ) # no dynamics
