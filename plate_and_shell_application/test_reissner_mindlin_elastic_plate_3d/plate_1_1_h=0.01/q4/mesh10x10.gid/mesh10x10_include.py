...
class Model:
    ...
    def WriteOutput( self, time ):
        ...
        # self.gid_io.WriteNodalResults(ROTATION, time, 0)
        # print("nodal ROTATION written")
        # self.gid_io.PrintOnGaussPoints(DISPLACEMENT, self.model_part, time)
        # print("gauss point DISPLACEMENT written")
        self.gid_io.PrintOnGaussPoints(ROTATION, self.model_part, time)
        print("gauss point ROTATION written")
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,        2e+05 )
        self.model_part.Properties[1].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[1].SetValue(SHEAR_STIFFNESS,          1.0 )
        self.model_part.Properties[1].SetValue(DRILLING_STIFFNESS,          1.0 )
        self.model_part.Properties[1].SetValue(THICKNESS,            0.01 )
        print("Linear elastic model selected for Isotropic3D, description: Plate")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
