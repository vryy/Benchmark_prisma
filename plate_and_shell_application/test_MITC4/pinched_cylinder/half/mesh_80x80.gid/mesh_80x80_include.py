...
class Model:
    ...
    def InitializeModel( self ):
        ...
        # self.model_part.Properties[1].SetValue(DRILLING_STIFFNESS,      3e8 )
        self.model_part.Properties[1].SetValue(DRILLING_STIFFNESS,      G*h )
        # self.model_part.Properties[1].SetValue(DRILLING_STIFFNESS,      1.2857e7 )
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, LinearElasticMembranePlate() )
