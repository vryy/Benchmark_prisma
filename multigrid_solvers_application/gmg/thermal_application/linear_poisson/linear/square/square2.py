...
for lvl in range(0, len(model_list)):
    solver_factory.SetModelPart(lvl, model_list[lvl].model_part)

solver_factory.SetProlongationOperator(StructuredMeshMGInterpolator2D())
#solver_factory.SetProlongationOperator(StructuredMeshMatrixBasedMGInterpolator2D())

solver_factory.SetRestrictionOperator(StructuredMeshMGTransposeInterpolator2D())
#solver_factory.SetRestrictionOperator(StructuredMeshMatrixBasedMGTransposeInterpolator2D())
#solver_factory.SetRestrictionOperator(StructuredMeshMGInjector2D())# not converge

solver_factory.SetTransferOperator(StructuredMeshMGInjector2D())
