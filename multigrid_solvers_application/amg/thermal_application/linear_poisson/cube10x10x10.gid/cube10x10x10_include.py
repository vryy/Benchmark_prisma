...
#        structural_solver_advanced.AddDofs( self.model_part )
        ...
        solver_plist.SetIntValue("max_coarse", 5000)
        solver_plist.SetStringValue("CF", "CLJP")
        plinear_solver.AddPreSmoother(JacobiIterativeSolver(1, 1.0))
        plinear_solver.AddPostSmoother(JacobiIterativeSolver(1, 1.0))
        plinear_solver.SetCoarseSolver(SkylineLUFactorizationSolver())
        plinear_solver.SetFactory(RugeStuebenSolverFactory(solver_plist))
        plinear_solver.SetCycle("W")
