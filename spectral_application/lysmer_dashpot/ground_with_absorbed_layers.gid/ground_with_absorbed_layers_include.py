...
class Model:
    ...
    def InitializeModel( self ):
        ...
        print("Linear elastic model selected for LinearElastic, description: LinearElastic")
        self.model_part.Properties[2].SetValue(DENSITY,         rho )
        self.model_part.Properties[2].SetValue(YOUNG_MODULUS,      E )
        self.model_part.Properties[2].SetValue(POISSON_RATIO,          nu )
        self.model_part.Properties[2].SetValue(THICKNESS,            1.0 )
        self.model_part.Properties[2].SetValue(CONSTITUTIVE_LAW, PlaneStrain() )
        self.model_part.Properties[2].SetValue(P_WAVE_VELOCITY, Cp )
        self.model_part.Properties[2].SetValue(S_WAVE_VELOCITY, Cs )
        print("Linear elastic model selected for Damping, description: LinearElastic")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
