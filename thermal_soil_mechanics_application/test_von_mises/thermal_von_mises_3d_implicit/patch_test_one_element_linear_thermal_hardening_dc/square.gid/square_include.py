...
class Model:
    ...
    def InitializeModel( self ):
        ...
        # material data is taken from Simo & Miehe, Associative coupled thermoplasticity
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, ThermalVonMises3dImplicitDC() )
        ...
        thermal_strain_law = LinearThermalStrainLaw(alpha, T0)
        thermal_strain_law.Assign(self.model_part.Properties[1], THERMAL_STRAIN_LAW, thermal_strain_law)
