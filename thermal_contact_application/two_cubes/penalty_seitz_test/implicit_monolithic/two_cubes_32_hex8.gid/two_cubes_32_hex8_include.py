...
from KratosMultiphysics.ThermalContactApplication import *
...
class Model:
    ...
    def WriteOutput( self, time ):
        ...
        self.gid_io.WriteNodalResults(GAP, self.model_part.Nodes, time, 0)
        print("nodal GAP written")
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      4000.0 )
        ...
        self.model_part.Properties[1].SetValue(THERMAL_CONDUCTIVITY, 52.0 )
        self.model_part.Properties[1].SetValue(THERMAL_EXPANSION, 0.0 )
        self.model_part.Properties[1].SetValue(SPECIFIC_HEAT_CAPACITY, 0.0 )
