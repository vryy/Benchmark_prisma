...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DENSITY,        997.5 )
        self.model_part.Properties[1].SetValue(BULK_MODULUS,        2e+06 )
        self.model_part.Properties[1].SetValue(VISCOSITY,          0.3 )
        self.model_part.Properties[1].SetValue(FLUID_EOS_CONSTANT,          7.0 )
        self.model_part.Properties[1].SetValue(THICKNESS,            1 )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, Fluid1() )
        print("Water model is selected as constitutive law")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
