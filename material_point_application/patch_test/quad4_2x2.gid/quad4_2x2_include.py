...
class Model:
    def __init__( self, problem_name, path, results_path ):
        ...
        self.model_part.AddNodalSolutionStepVariable(NODAL_MASS)
        self.model_part.AddNodalSolutionStepVariable(LINEAR_MOMENTUM)
        ##################################################################
        ## READ MODELPART ################################################
        ##################################################################
        #reading a model
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(GRAVITY,         gravity )
