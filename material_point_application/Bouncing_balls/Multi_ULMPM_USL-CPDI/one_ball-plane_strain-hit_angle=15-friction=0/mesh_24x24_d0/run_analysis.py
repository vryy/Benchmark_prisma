...
def GetParams():
    ...
    params["particle_definition"] = "solid_cpdi_large_strain"
...
def test():
    ...
    ref_cx = 8.7895209687671205e-01
    ref_cy = 3.2356255937898254e-01
    ref_energy = 1.9440125103109174e+03
    # TODO the energy is too high, there is problem in the CDPI formulation
