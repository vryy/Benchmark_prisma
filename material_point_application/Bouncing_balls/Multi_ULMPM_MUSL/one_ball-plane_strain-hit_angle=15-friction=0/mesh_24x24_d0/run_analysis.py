...
##################################################################
##################################################################
simulator_path = os.path.join(os.environ.get('BENCHMARK_PRISMA', ''), "material_point_application", "Bouncing_balls")
...
def GetParams():
    ...
    params["mpm_scheme"] = "MUSL"
    params["ignore_invalid_particles"] = False
...
def test():
    ...
    ref_cx = 8.6614910664857281e-01
    ref_cy = 5.8270685758889185e-01
    ref_energy = 1.2668130632823618e+00
