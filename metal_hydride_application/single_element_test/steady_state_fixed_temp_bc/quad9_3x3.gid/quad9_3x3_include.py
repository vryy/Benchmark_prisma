...
class Model:
    ...
    def AddDofsForNodes(self, nodes):
        ...
        for node in nodes:
            node.AddDof(DENSITY, REACTION_DENSITY)
    ...
    def WriteOutput( self, time ):
        ...
        print("gauss point PERMEABILITY_AIRE written")
    ...
    def InitializeModel( self ):
        ...
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, PlaneStrain() ) # unused
        ...
        self.model_part.Properties[1].SetValue(MH_TORTUOSITY_SOLID,   1.5 ) # [1]
        self.model_part.Properties[1].SetValue(MH_TORTUOSITY_GAS,   1.5 ) # [1]
        print("Synthetic parameters selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
