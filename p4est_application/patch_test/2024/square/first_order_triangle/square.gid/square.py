...
def ConstructModelPart(p4est_model, order):
    ...
    if order == 1:
        element_name = "KinematicLinear2D3N"
    elif order == 2:
        element_name = "KinematicLinear2D6N"
    ...
    layer_idx = 1
    prop.SetValue(CREATE_ELEMENT_OPTION, P4estCreateElementOption.TRIANGLE_LEFT)
...
def Solve(model, p4est_model, time, output=True):
    ...
    if output:
        ...
        p4est_model.ExportVTK("cell", time, True, True)
