...
class Model:
    def __init__( self, problem_name, path, results_path, logging = True ):
        ...
        self.analysis_parameters['solution_strategy'] = "initial_stiffness"
        ...
        # self.analysis_parameters['overrelaxation_factor'] = 1.0
        # self.analysis_parameters['residuum_tolerance'] = 1.e-4
        ...
        (self.solver.solver).max_iter = 2000 #control the maximum iterations of Newton Raphson loop
    ...
    def InitializeModel( self ):
        ...
        # ## parameters from Table 2 of paper:
        # ## Cocco et al, Numerical implementation of hardening soil model, 2018
        # mat_params = Vector(16)
        # mat_params[0] = 3.0e4   # E50ref
        # mat_params[1] = 3.0e4   # Eoedref
        # mat_params[2] = 9.0e4   # Eurref
        # mat_params[3] = 0.55    # me
        # mat_params[4] = 0.0     # c
        # mat_params[5] = 42.0    # phi
        # mat_params[6] = 16.0    # psi
        # mat_params[7] = 0.25    # nuur
        # mat_params[8] = 100.0   # pref
        # mat_params[9] = 0.4     # K0nc
        # mat_params[10] = 0.9    # Rf
        # mat_params[11] = 0.0    # sigma_trac
        # mat_params[12] = 6.5e4  # Eiref
        # mat_params[13] = 1.447  # alpha
        # mat_params[14] = 100.0/75215.757  # beta = pref/H when c=0
        # mat_params[15] = 1.0    # OCR
        ## parameters from Table 2 of paper:
        ## Cocco et al, Numerical implementation of hardening soil model, 2018
        ## after calibration with NEED_DETERMINE_INTERNAL_PARAMS = True
        mat_params = Vector(16)
        mat_params[0] = 3.0e4   # E50ref
        mat_params[1] = 3.0e4   # Eoedref
        mat_params[2] = 9.0e4   # Eurref
        ...
        mat_params[10] = 0.9    # Rf
        mat_params[11] = 0.0    # sigma_trac
        mat_params[12] = 128e3  # Eiref
        mat_params[13] = 1.447  # alpha
        mat_params[14] = 2.8e-3 # beta
        mat_params[15] = 1.0    # OCR
        # ## TAN data
        # mat_params = Vector(16)
        # mat_params[0] = 3.0e4   # E50ref
        # mat_params[1] = 3.0e4   # 37128.212994212474   # Eoedref
        # mat_params[2] = 9.0e4   # Eurref
        # mat_params[3] = 0.55    # me
        # mat_params[4] = 0.0     # c
        # mat_params[5] = 42.0    # phi
        ...
        # mat_params[7] = 0.25    # nuur
        # mat_params[8] = 100.0   # pref
        # mat_params[9] = 0.4     # 0.46738502218038469     # K0nc
        # mat_params[10] = 0.9    # Rf
        # mat_params[11] = 0.0    # sigma_trac
        # mat_params[12] = 60e3   # 93557.026558714919  # Eiref
        # mat_params[13] = 0.0    # 1.447  # alpha
        # mat_params[14] = 0.0    # 100.0/75215.757  # beta = pref/H when c=0
        # mat_params[15] = 1.0    # OCR
        ## parameters from Iterative.f90 for hss of ephyss PhD thesis:
        ## Castellon et al, Estudio del comportamiento del suelo en el rango de las pequenas deformaciones y desarrollo del modelo constitutivo EPHYSS, page 585
        # mat_params = Vector(16)
        # mat_params[0] = 4.0e4   # E50ref
        # mat_params[1] = 3.0e4   # Eoedref
        # mat_params[2] = 12.0e4  # Eurref
        # mat_params[3] = 0.5     # me
        # mat_params[4] = 0.0     # c
        # mat_params[5] = 40.0    # phi
        # mat_params[6] = 10.0    # psi
        # mat_params[7] = 0.20    # nuur
        # mat_params[8] = 100.0   # pref
        # mat_params[9] = 0.36    # K0nc
        # mat_params[10] = 0.9    # Rf
        # mat_params[11] = 0.0    # sigma_trac
        # mat_params[12] = 115913.0 # 11.6e4 # Eiref
        # mat_params[13] = 4.141  # alpha
        # mat_params[14] = 0.00141 # beta
        # mat_params[15] = 1.0    # OCR
        ##
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, ElasticTangentConstitutiveLaw(UDSMImplicit()) )
        self.model_part.Properties[1].SetValue(MATERIAL_PARAMETERS, mat_params )
        self.model_part.Properties[1].SetValue(NEED_DETERMINE_INTERNAL_PARAMS, False )
        self.model_part.Properties[1].SetValue(USE_NUMERICAL_TANGENT, False )
        self.model_part.Properties[1].SetValue(EPSILON, 1e-8 )
        print("UDSM implicit model selected, description: Linear Elastic")
        print("Hardening soil model selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
