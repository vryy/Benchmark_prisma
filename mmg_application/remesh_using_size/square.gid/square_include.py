...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      2.1e5 )
        ...
        print("Linear elastic model selected for Bulk, description: Isotropic3D")
        self.model_part.Properties[2].SetValue(DENSITY,         7620 )
        self.model_part.Properties[2].SetValue(YOUNG_MODULUS,      2.1e7 )
        ...
        print("Linear elastic model selected for Embed, description: Isotropic3D")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
