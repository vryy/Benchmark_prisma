...
def test():
    ...
    l2_error_ref = 1.9160067447492154e-05
    h1_error_ref = 2.5058723371038120e-03
    h1_error_rs_ref = 6.0722267136711200e-04
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        main(name='mesh10x10', output=True, logging=True, mesh_size=20., stress_recovery_type=0, neighbour_expansion_level=2)
