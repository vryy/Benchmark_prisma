...
class Model:
    ...
    def InitializeModel( self ):
        ...
        print("User-defined material selected for UserDefined, description: UserDefined")
        ...
        print("User-defined material selected for B1, description: UserDefined")
        ...
        print("User-defined material selected for B2, description: UserDefined")
        self.model_part.Properties[4].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[4].SetValue(CONSTITUTIVE_LAW, DummyConstitutiveLaw() )
        print("User-defined material selected for B3, description: UserDefined")
        self.model_part.Properties[5].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[5].SetValue(CONSTITUTIVE_LAW, DummyConstitutiveLaw() )
        print("User-defined material selected for BL, description: UserDefined")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
