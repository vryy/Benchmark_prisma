...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, OofemIsotropicLinearElasticMaterialPlaneStrain() )
        print("Linear elastic model selected for square, description: OofemIsotropicLinearElasticMaterialPlaneStrain")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
