...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_wf,         148.13e-6 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_fc,         30e6 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_ft,         3e6 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_hp,         0.01 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_yieldtol,         1e-6 )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, OofemConcreteDPM2() )
        self.model_part.Properties[2].SetValue(MAT_RESPONSE_MODE, 0 )  # 0: tangent; 1: secant; 3: elastic
