##################################################################
# CDPM2, Single element test - uniaxial tension
...
def main(logging=True, output=True, nsteps=200, delta_time=1e-6, total_disp = 2e-3):
...
def test():
    model = main(logging=False, output=False, nsteps=100, delta_time=1e-4)

    reac = model.model_part.Nodes[2].GetSolutionStepValue(REACTION_X)
    ref_reac = 2.8406791809977208e+03
