...
class Model:
    ...
    def InitializeModel( self, integration_order=1 ):
        ...
        self.model_part.Properties[1].SetValue(IFT_IsotropicLinearElasticMaterial_e,         5e10 )
        self.model_part.Properties[1].SetValue(IFT_IsotropicLinearElasticMaterial_n,         0.15 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_wf,         0.002 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_fc,         35e6 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_ft,         3.5e6 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_ftOne,      1.5e6 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_wfOne,      0.00075 )
        ...
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_asoft,         15.0 )
        self.model_part.Properties[1].SetValue(IFT_ConcreteDPM2_softeningType,    1 ) # 0: linear; 1: bilinear; 2: exponential
