...
from KratosMultiphysics.MfemApplication import *
kernel = Kernel()   #defining kernel

##################################################################
##################################################################
class Model:
    def __init__( self, problem_name, path, results_path, write_log ):
        ...
        self.analysis_parameters['log_residuum'] = write_log
        ...
        self.gid_io = MfemGidPostIO( os.getcwd()+"/"+problem_name, post_mode, multi_file_flag, write_deformed_flag, write_elements )
