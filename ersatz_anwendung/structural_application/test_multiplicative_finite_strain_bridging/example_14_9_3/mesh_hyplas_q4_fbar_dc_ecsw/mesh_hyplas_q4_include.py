...
class Model:
    ...
    def WriteOutput( self, time ):
        ...
        self.gid_io.PrintOnElement(ELEMENT_WEIGHT, self.model_part, time)
        print("elements ELEMENT_WEIGHT written")
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(IS_FBAR,            True )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainBridgingConstitutiveLawDC_Kirchhoff(VonMises3dImplicitDC()) )
