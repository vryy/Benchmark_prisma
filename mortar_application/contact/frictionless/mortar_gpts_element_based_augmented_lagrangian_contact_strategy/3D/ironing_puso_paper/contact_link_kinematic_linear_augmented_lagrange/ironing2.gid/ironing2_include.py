...
class Model:
    def __init__( self, problem_name, path, results_path, logging=True ):
        ...
        self.analysis_parameters['stop_active_set_if_not_converged'] = False
        ...
        ## ADD DOFS ######################################################
        ##################################################################
        mortar_gpts_element_based_augmented_lagrangian_contact_strategy.AddDofs( self.model_part )
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DENSITY,         1000 )
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,         1000 )
        ...
        print("Linear elastic model selected for die, description: Die")
        self.model_part.Properties[2].SetValue(DENSITY,            0 )
        self.model_part.Properties[2].SetValue(YOUNG_MODULUS,            1 )
        ...
        print("Linear elastic model selected for slab, description: Slab")
        ##################################################################
