...
def main(logging=True, output=True):
    ...
    mortar_links = tying_util.SetupTyingLinkElementBased(model.model_part, 20, "tying_link_kinematic_linear_lagrange_std_mortar")
    # sys.exit(0)
    ...
    model.solver.solver.Parameters['penalty'] = {10: 1e4}
    ...
    for step in range(0, 64): #44): #64): #10):
        # as of 7/2025, it cannot go to step 64 with StVenantKirchhoff
...
def test():
    ...
    print("%.16e" % (disp_x))
    print("%.16e" % (disp_y))
    ## result with AMD laptop
    # ref_disp_x = 4.0000386679473383e+00
    # ref_disp_y = -6.2114284252164875e-01
    ## result with Intel i9-13950HX laptop
    ref_disp_x = 4.0000386642926031e+00
    ref_disp_y = -6.2114284147417809e-01
