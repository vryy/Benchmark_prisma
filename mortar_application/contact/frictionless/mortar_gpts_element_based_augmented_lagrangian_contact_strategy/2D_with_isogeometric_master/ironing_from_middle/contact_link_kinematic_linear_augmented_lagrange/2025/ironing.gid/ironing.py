...
def test():
    ...
    print("%.16e" % (disp_x))
    print("%.16e" % (disp_y))
    # ref_disp_x = 4.0000631187716778e+00
    ref_disp_x = 4.0000631220699159e+00
    # ref_disp_y = -6.3062289487003087e-01
    ref_disp_y = -6.3062289495730217e-01
    assert(abs(disp_x - ref_disp_x) < 1e-6)
    assert(abs(disp_y - ref_disp_y) < 1e-6)
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        main(logging=True, output=True, npush=0, nslide=0)
