...
def main(logging=True, output=True):
    ...
    model.solver.solver.contact_tying_indices[10] = "contact_gptms_g1n_link_kinematic_linear_augmented_lagrange"
...
def test():
    ...
    print("%.16e" % (disp_x))
    print("%.16e" % (disp_y))
    ref_disp_x = 4.0000673238224183e+00
    ref_disp_y = -6.3254316981055925e-01
