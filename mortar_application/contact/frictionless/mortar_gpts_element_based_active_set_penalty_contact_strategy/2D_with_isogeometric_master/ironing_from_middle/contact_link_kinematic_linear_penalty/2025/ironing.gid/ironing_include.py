...
class Model:
    def __init__( self, problem_name, path, results_path, logging=True ):
        ...
        ## generating solver
        self.solver = mortar_gpts_element_based_active_set_penalty_contact_strategy.SampleSolver(self.model_part, self.abs_tol, self.rel_tol, self.analysis_parameters)
    ...
    def AddVariables(self, model_part):
        mortar_gpts_element_based_active_set_penalty_contact_strategy.AddVariables( model_part )

    def AddDofs(self, model_part):
        mortar_gpts_element_based_active_set_penalty_contact_strategy.AddDofs( model_part )

    def AddDofsForNodes(self, nodes):
        mortar_gpts_element_based_active_set_penalty_contact_strategy.AddDofsForNodes( nodes )
