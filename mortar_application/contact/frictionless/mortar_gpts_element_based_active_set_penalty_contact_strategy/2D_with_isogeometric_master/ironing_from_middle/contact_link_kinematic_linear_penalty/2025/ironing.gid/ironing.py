...
def main(logging=True, output=True):
    ...
    # model.solver.solver.Parameters['active_set_convergence_criteria'] = "check gap"
    # model.solver.solver.Parameters['active_set_gap_tol'] = 1e-4
    ...
    model.solver.solver.Parameters['query_tool'] = IsogeometricBVHProjectionQueryTool2DMaster()
...
def test():
    ...
    print("%.16e" % (disp_x))
    print("%.16e" % (disp_y))
    ref_disp_x = 4.0000643489663643e+00
    ref_disp_y = -6.3071293339855272e-01
