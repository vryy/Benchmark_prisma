...
def main(logging=True, output=True):
    ...
    model.solver.solver.contact_tying_indices[10] = "contact_gptms_g1n_link_kinematic_linear_penalty"
...
def test():
    ...
    print("%.16e" % (disp_x))
    print("%.16e" % (disp_y))
    ref_disp_x = 3.9999897165667044e+00
    ref_disp_y = -6.3266666867267929e-01
