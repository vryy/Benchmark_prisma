...
def main(logging=True, output=True):
    ...
    model.solver.solver.contact_tying_indices[10] = "contact_gptms_c0n_link_kinematic_linear_penalty"
...
def test():
    ...
    print("%.16e" % (disp_x))
    print("%.16e" % (disp_y))
    ref_disp_x = 4.0002887708476056e+00
    ref_disp_y = -6.3483251086573533e-01
