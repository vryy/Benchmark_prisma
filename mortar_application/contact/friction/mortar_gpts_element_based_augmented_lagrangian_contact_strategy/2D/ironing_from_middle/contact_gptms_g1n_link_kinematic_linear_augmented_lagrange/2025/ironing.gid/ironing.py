...
def main(logging=True, output=True, npush=64, nslide=400):
    ...
    model.solver.solver.contact_tying_indices[10] = "contact_gptms_g1n_link_kinematic_linear_augmented_lagrange_regularized_coulomb_friction"
    ...
    model.solver.solver.Parameters['query_tools'][10] = ButterflyPatchProjectionQueryTool2D()
...
def test():
    model = main(logging=False, output=False, npush=64, nslide=400)
    ...
    print("%.16e" % (disp_x))
    print("%.16e" % (disp_y))
    ref_disp_x = 3.8840027870383000e+00
    ref_disp_y = -6.3390617368451263e-01
