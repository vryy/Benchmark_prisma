...
#                        #item.Free(AIR_PRESSURE)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      2.1e+6 )
        ...
        self.inner_boundary_elements = model_layers.ReadInnerBoundaryElements()
        ## NODES on layers ###############################################
        ...
        self.inner_boundary_nodes = model_layers.ReadInnerBoundaryNodes()
        ##################################################################
