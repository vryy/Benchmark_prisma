...
class Model:
    def __init__( self, problem_name, path, results_path, logging=True ):
        ...
        self.analysis_parameters['dissipation_radius'] = 0.8 # 0.1
        self.analysis_parameters['solution_strategy'] = "arc_length_displacement_control"
        self.analysis_parameters['arc_length_constraint_type'] = "sphere"
        self.analysis_parameters['arc_length_solution_scheme'] = "non-consistent"
        self.analysis_parameters['arc_length_load_scale_factor'] = 1.0
        self.analysis_parameters['arc_length_radius'] = 0.01
