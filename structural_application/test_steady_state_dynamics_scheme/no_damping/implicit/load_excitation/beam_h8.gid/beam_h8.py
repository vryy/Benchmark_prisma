...
def main(logging=True, output=True):
    ...
    gravity[0] = 0.0
    gravity[1] = 0.0
    gravity[2] = -g # here we apply the gravity in the frequency domain,
        # translating to the time domain we have sinus gravity. It is not real
        # but here is just a test
