...
class Model:
    def __init__( self, problem_name, path, results_path, logging=True ):
        ...
        self.analysis_parameters['analysis_type'] = 10
        self.analysis_parameters['solution_strategy'] = 'explicit'
        self.analysis_parameters['omega'] = 2*math.pi*10
    ...
    def InitializeModel( self ):
        ...
        print("Linear elastic model selected for Isotropic3D, description: Concrete")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
