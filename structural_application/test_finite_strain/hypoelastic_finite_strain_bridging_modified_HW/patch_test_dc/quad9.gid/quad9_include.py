...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      7e4 )
        self.model_part.Properties[1].SetValue(POISSON_RATIO,          0.33 )
        self.model_part.Properties[1].SetValue(THICKNESS,            1 )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, HypoelasticFiniteStrainBridgingConstitutiveLawDC_Kirchhoff(Isotropic3DDC()) )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, HypoelasticFiniteStrainBridgingConstitutiveLaw_Kirchhoff(Isotropic3D()) )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, HypoelasticFiniteStrainBridgingConstitutiveLaw_Kirchhoff(LinearElasticPlaneStrain()) )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, HypoelasticFiniteStrainBridgingConstitutiveLawDC_Kirchhoff(LinearElasticPlaneStrainDC()) )
