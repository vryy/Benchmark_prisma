...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW,  MultiplicativeFiniteStrainAxisymmetricBridgingConstitutiveLaw_Kirchhoff(LinearElasticAxisymmetric()) )
        print("Linear elastic model selected, description: Axisymmetric")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
