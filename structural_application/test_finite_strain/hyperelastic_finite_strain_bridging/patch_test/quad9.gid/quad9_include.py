...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, HyperelasticFiniteStrainBridgingConstitutiveLaw(StVenantKirchhoff_PlaneStrain()) )
        print("St-Venant Kirchhoff model selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
