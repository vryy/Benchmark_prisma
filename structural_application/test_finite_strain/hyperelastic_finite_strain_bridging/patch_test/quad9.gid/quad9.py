...
def main(output=True, logging=True, output_last=False, total_disp=0.75):
    ...
    # Note that DetF will be zero after 0.75, leading to singular matrix
...
def test():
    model = main(output=False, logging=False, output_last=False, total_disp=0.74)
    ...
    ######### pytesting results #########
    # ref_reac = 1.4247532693e+05 # 0.75
    ref_reac = 1.385712491629472e+05 # 0.74
    reac = 0.0
    for node in prescribed_nodes:
