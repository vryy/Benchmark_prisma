...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, IsotropicDamageModel() )
        ...
        self.model_part.Properties[1].SetValue(DAMAGE_E0, e0 )
        self.model_part.Properties[1].SetValue(DAMAGE_EF, ef )
