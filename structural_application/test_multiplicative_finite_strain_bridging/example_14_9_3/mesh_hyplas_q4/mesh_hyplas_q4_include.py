...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,        206.9 )
        self.model_part.Properties[1].SetValue(POISSON_RATIO,          0.29 )
        self.model_part.Properties[1].SetValue(THICKNESS,            1 )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainBridgingConstitutiveLaw_Kirchhoff(VonMises3dImplicit()) )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainBridgingConstitutiveLawDC(VonMises3dImplicitDC()) )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainBridgingConstitutiveLaw(VonMises3dImplicit()) )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, VonMises3dImplicitDC() )
        hlaw = PiecewiseLinearHardeningLaw()
        hlaw.AddPoint(0.000,   0.45)
        hlaw.AddPoint(0.001,   0.454435762)
        hlaw.AddPoint(0.002,   0.458796841)
        hlaw.AddPoint(0.005,   0.471444418)
        hlaw.AddPoint(0.01,    0.491143029)
        hlaw.AddPoint(0.02,    0.525858133)
        hlaw.AddPoint(0.03,    0.555146425)
        hlaw.AddPoint(0.04,    0.5798531)
        hlaw.AddPoint(0.05,    0.600691721)
        hlaw.AddPoint(0.06,    0.618264715)
        hlaw.AddPoint(0.07,    0.633080684)
        hlaw.AddPoint(0.08,    0.645569021)
        hlaw.AddPoint(0.09,    0.656092241)
        hlaw.AddPoint(0.10,    0.664956399)
        hlaw.AddPoint(0.12,    0.678700849)
        hlaw.AddPoint(0.14,    0.688423202)
        hlaw.AddPoint(0.16,    0.695278735)
        hlaw.AddPoint(0.20,    0.703446598)
        hlaw.AddPoint(0.25,    0.707922245)
        hlaw.AddPoint(0.3,     0.709472875)
        hlaw.AddPoint(0.5,     0.70848216)
        hlaw.AddPoint(1.0,     0.702075988)
        hlaw.AddPoint(11.0,    0.572836)
        hlaw.Assign(ISOTROPIC_HARDENING_LAW, hlaw, self.model_part.Properties[1])
        print("Multiplicative finite strain bridging constitutive law is selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
