...
class Model:
    ...
    def InitializeModel( self ):
        ...
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainBridgingConstitutiveLawDC(PlaneStrainDC()) )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainBridgingConstitutiveLawDC_Kirchhoff(Isotropic3DDC()) )
