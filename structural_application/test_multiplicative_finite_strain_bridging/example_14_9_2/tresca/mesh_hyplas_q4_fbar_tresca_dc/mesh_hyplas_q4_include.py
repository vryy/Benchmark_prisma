...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainAxisymmetricBridgingConstitutiveLawDC_Kirchhoff(Tresca3dImplicitDC()) )
        hlaw = PiecewiseLinearHardeningLaw()
        coef = 1.0 #2.0/(3**0.5)
        hlaw.AddPoint(  0.0     ,   0.45        * coef   )
        hlaw.AddPoint(  0.001   ,   0.454577    * coef   )
        hlaw.AddPoint(  0.002   ,   0.459081    * coef   )
        hlaw.AddPoint(  0.005   ,   0.472155    * coef   )
        hlaw.AddPoint(  0.01    ,   0.492564    * coef   )
        hlaw.AddPoint(  0.02    ,   0.528701    * coef   )
        hlaw.AddPoint(  0.03    ,   0.559411    * coef   )
        hlaw.AddPoint(  0.04    ,   0.585539    * coef   )
        hlaw.AddPoint(  0.05    ,   0.607799    * coef   )
        hlaw.AddPoint(  0.06    ,   0.626794    * coef   )
        hlaw.AddPoint(  0.07    ,   0.643032    * coef   )
        hlaw.AddPoint(  0.08    ,   0.656942    * coef   )
        hlaw.AddPoint(  0.09    ,   0.668887    * coef   )
        hlaw.AddPoint(  0.1     ,   0.679172    * coef   )
        hlaw.AddPoint(  0.12    ,   0.69576     * coef   )
        hlaw.AddPoint(  0.14    ,   0.708326    * coef   )
        hlaw.AddPoint(  0.16    ,   0.718025    * coef   )
        hlaw.AddPoint(  0.2     ,   0.731879    * coef   )
        hlaw.AddPoint(  0.25    ,   0.743463    * coef   )
        hlaw.AddPoint(  0.3     ,   0.752122    * coef   )
        hlaw.AddPoint(  0.5     ,   0.779564    * coef   )
        hlaw.AddPoint(  1.0     ,   0.84424     * coef   )
        hlaw.AddPoint(  11.0    ,   2.13664     * coef   )
