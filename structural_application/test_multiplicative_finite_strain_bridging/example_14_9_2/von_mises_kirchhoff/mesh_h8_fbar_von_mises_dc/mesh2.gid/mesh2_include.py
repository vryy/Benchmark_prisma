...
class Model:
    ...
    def InitializeModel( self ):
        ...
        hlaw.AddPoint(  0.0     ,   0.45        )
        hlaw.AddPoint(  0.001   ,   0.454577    )
        hlaw.AddPoint(  0.002   ,   0.459081    )
        hlaw.AddPoint(  0.005   ,   0.472155    )
        hlaw.AddPoint(  0.01    ,   0.492564    )
        hlaw.AddPoint(  0.02    ,   0.528701    )
        hlaw.AddPoint(  0.03    ,   0.559411    )
        hlaw.AddPoint(  0.04    ,   0.585539    )
        hlaw.AddPoint(  0.05    ,   0.607799    )
        hlaw.AddPoint(  0.06    ,   0.626794    )
        hlaw.AddPoint(  0.07    ,   0.643032    )
        hlaw.AddPoint(  0.08    ,   0.656942    )
        hlaw.AddPoint(  0.09    ,   0.668887    )
        hlaw.AddPoint(  0.1     ,   0.679172    )
        hlaw.AddPoint(  0.12    ,   0.69576     )
        hlaw.AddPoint(  0.14    ,   0.708326    )
        hlaw.AddPoint(  0.16    ,   0.718025    )
        hlaw.AddPoint(  0.2     ,   0.731879    )
        hlaw.AddPoint(  0.25    ,   0.743463    )
        hlaw.AddPoint(  0.3     ,   0.752122    )
        hlaw.AddPoint(  0.5     ,   0.779564    )
        hlaw.AddPoint(  1.0     ,   0.84424     )
        hlaw.AddPoint(  11.0    ,   2.13664     )
