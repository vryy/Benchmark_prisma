...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainAxisymmetricBridgingConstitutiveLaw_Kirchhoff(VonMises3dImplicit()) )
        # self.model_part.Properties[1].SetValue(LOCAL_ERROR_TOLERANCE, 1e-3 )
