...
class Model:
    ...
    def InitializeModel( self ):
        ...
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, TotalLagrangianBridgingConstitutiveLaw(GTN3dImplicit()) )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, MultiplicativeFiniteStrainBridgingConstitutiveLawDC_Kirchhoff(GTN3dImplicitDC()) )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, LinearElasticAxisymmetric() )
