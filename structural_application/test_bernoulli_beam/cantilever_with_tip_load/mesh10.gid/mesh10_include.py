...
class Model:
    ...
    def AddDofs(self, model_part):
        self.AddDofsForNodes(model_part.Nodes)
    ...
    def InitializeModel( self ):
        ...
        b = 0.1
        h = 0.1
        self.model_part.Properties[1].SetValue(CROSS_AREA,          b*h )
        inertia = Matrix(2, 2)
        inertia[0,0] = b*h**3/12
        inertia[1,1] = h*b**3/12
        inertia[0,1] = 0.0
        print("inertia:", b*h**3/12)
        self.model_part.Properties[1].SetValue(LOCAL_INERTIA,          inertia )
