...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(IS_FBAR,            False )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, HypoelasticFiniteStrainBridgingConstitutiveLaw_Cauchy(VonMises3dImplicit()) )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, HypoelasticFiniteStrainBridgingConstitutiveLaw_Kirchhoff(VonMises3dImplicit()) )
        ...
        print("Hypoelastic finite strain bridging constitutive law is selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
