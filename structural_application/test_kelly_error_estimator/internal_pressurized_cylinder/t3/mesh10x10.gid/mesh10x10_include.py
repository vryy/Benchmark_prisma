...
class Model:
    ...
    def WriteOutput( self, time ):
        ...
        print("element LOCAL_ERROR written")
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[2].SetValue(YOUNG_MODULUS,      2.1e5 )
        ...
        print("Linear elastic model selected for Load, description: steel")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
