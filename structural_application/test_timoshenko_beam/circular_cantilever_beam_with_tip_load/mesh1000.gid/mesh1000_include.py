...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      1.91e8 )
        self.model_part.Properties[1].SetValue(POISSON_RATIO,          0.3 )
        b = 0.1
        h = 0.1
        k = 5.0/6
        self.model_part.Properties[1].SetValue(AREA,            b*h )
        self.model_part.Properties[1].SetValue(AREA_Y,          k*b*h )
        self.model_part.Properties[1].SetValue(AREA_Z,          k*b*h )
        self.model_part.Properties[1].SetValue(INERTIA_X ,      1.0e-10 )
        self.model_part.Properties[1].SetValue(INERTIA_Y,       b*h**3/12 )
        self.model_part.Properties[1].SetValue(INERTIA_Z,       h*b**3/12 )
        print("Beam material selected for TrussProperties, description: beam")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
