...
#        plinear_solver = BICGSTABSolver(1e-9, 300, ILU0Preconditioner())
        #plinear_solver = BICGSTABSolver(1e-9, 300, MultithreadedILUPreconditioner())

        #params = "{}"
        params = '{"solver_type" : "AMGCL",\
                   "smoother_type":"ilu0",\
                   "krylov_type": "gmres",\
        ...
        plinear_solver = AMGCLSolver(solver_params)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,        1e+05 )
        ...
        self.model_part.Properties[2].SetValue(YOUNG_MODULUS,        1e+05 )
        ...
        print("Linear elastic model selected for Force1, description: Isotropic3D")
        ...
        self.model_part.Properties[3].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[3].SetValue(CONSTITUTIVE_LAW, PlaneStrain() )
        print("Linear elastic model selected for Force2, description: Isotropic3D")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
