...
def main(output=True, logging=True):
    ...
    print("RAYLEIGH_DAMPING_ALPHA: ", dynmodel.model_part.Properties[1].GetValue(RAYLEIGH_DAMPING_ALPHA))
    print("RAYLEIGH_DAMPING_BETA: ", dynmodel.model_part.Properties[1].GetValue(RAYLEIGH_DAMPING_BETA))
...
def test():
    ...
    print("vy: %.16e" % vy)
    print("ay: %.16e" % ay)
    ref_dy = 1.9789494332987427e-02
    ref_vy = -1.6035308958506175e-02
    ref_ay = -4.6698414933010017e-03
