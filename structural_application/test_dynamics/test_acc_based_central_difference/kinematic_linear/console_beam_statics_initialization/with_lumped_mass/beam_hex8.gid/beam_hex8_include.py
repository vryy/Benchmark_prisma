...
##################################################################
class Model:
    def __init__( self, problem_name, path, results_path, logging=True, option = 1 ):
        ...
        if option == 1:
            ...
            self.analysis_parameters['use_lumped_mass'] = True
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      2.0e6 )
        ...
        # self.model_part.Properties[1].SetValue(RAYLEIGH_DAMPING_ALPHA, 1.0e-2 )
        # self.model_part.Properties[1].SetValue(RAYLEIGH_DAMPING_BETA, 1.0e-2 )
