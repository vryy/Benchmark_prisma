...
##################################################################
class Model:
    def __init__( self, problem_name, path, results_path, analysis_type = 0, logging=True ):
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DENSITY,         2400 )
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      3.5e10 )
