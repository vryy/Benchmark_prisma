...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DENSITY,         3000 )
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,        4e+06 )
        ...
        print("Linear elastic model selected for Isotropic3D, description: PlaneStrain")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
