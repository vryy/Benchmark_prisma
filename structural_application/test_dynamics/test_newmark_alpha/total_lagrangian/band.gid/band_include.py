...
##################################################################
class Model:
    def __init__( self, problem_name, path, results_path, analysis_type, dissipation_radius, damping_alpha, damping_beta, logging=True ):
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DENSITY,         1000.0 )
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      5.6e6 )
        ...
        self.model_part.Properties[1].SetValue(RAYLEIGH_DAMPING_ALPHA, self.damping_alpha )
        self.model_part.Properties[1].SetValue(RAYLEIGH_DAMPING_BETA, self.damping_beta )
        print("Neo Hookean model selected for Band, description: Flap")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
