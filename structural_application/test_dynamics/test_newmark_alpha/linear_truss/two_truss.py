...
def test():
    ...
    assert(abs(vx/B2 - ref_values[2]) / abs(ref_values[2]) < 1e-13)
    assert(abs(vy/H - ref_values[3]) / abs(ref_values[3]) < 1e-13)
    assert(abs(ax/B2 - ref_values[4]) / abs(ref_values[4]) < 1e-13)
    assert(abs(ay/H - ref_values[5]) / abs(ref_values[5]) < 1e-13)
    print("Test passed")
