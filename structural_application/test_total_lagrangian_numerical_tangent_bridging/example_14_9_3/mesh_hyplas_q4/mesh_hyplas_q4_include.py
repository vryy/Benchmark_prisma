...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, TotalLagrangianNumericalTangentBridgingConstitutiveLaw(TotalLagrangianBridgingConstitutiveLaw(VonMises3dImplicit())) )
