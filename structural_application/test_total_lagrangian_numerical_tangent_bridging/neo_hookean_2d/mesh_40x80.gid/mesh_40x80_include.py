...
class Model:
    ...
    def InitializeModel( self ):
        ...
        # self.model_part.Properties[1].SetValue(INTEGRATION_ORDER,      4 )
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, TotalLagrangianNumericalTangentBridgingConstitutiveLaw(NeoHookean2D()) )
        print("Linear elastic model selected for bulk, description: NeoHookean2D")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
