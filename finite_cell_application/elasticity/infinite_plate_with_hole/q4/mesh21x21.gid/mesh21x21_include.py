...
##################################################################
class Model:
    def __init__( self, problem_name, path, results_path, logging=True, post_mode="binary" ):
    ...
    def WriteOutput( self, time ):
        ...
        self.gid_io.WriteNodalResults(VON_MISES_STRESS, self.model_part.Nodes, time, 0)
        print("nodal VON_MISES_STRESS written")
    ...
    def InitializeModel( self ):
        ...
        print("Linear elastic model selected for Forcex, description: Isotropic3D")
        ...
        self.model_part.Properties[3].SetValue(CONSTITUTIVE_LAW, PlaneStress() )
        print("Linear elastic model selected for Forcey, description: Isotropic3D")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
