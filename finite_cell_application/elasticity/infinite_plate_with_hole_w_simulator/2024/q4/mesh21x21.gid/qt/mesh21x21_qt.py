...
def main(logging=True, output=True):
    model = mesh21x21_include.Model('mesh21x21',os.getcwd()+"/",os.getcwd()+"/",logging=logging,post_mode="ascii")
...
def test():
    ...
    ref_l2_error = 4.073926200151070e-03
    ref_h1_error = 3.405603913724561e-02
