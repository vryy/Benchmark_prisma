...
class Model:
    ...
    def WriteOutput( self, time ):
        ...
        self.gid_io.PrintOnGaussPoints(PLASTIC_MODE, self.model_part, time)
        print("gauss point PLASTIC_MODE written")
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, GTNGbImplicit() )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, GTNGbImplicitDC() )
