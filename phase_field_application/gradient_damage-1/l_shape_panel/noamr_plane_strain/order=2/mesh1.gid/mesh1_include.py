...
class Model:
    ...
    def AddDofs(self, model_part):
        ...
        for node in model_part.Nodes:
            node.AddDof(LAGRANGE_MULTIPLIER_CONSTRAINT, TEMPERATURE) # dummy variable to calculate the reaction forces
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,      10.0e3 )
        ...
        self.model_part.Properties[1].SetValue(ALPHA_PARAMETER,            0.98 )
        self.model_part.Properties[1].SetValue(BETA_PARAMETER,            80.0 )
        self.model_part.Properties[1].SetValue(KAPPA_0,            4e-4 )
        ...
        self.model_part.Properties[1].SetValue(LENGTH_SCALE,            5.0*math.sqrt(2.0) )
        # self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, PlaneStrain() )
        print("Linear elastic model selected for Isotropic3D, description: Bulk")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
