def ReadLayerSets():
    ...
    layer_sets['load_1'] = layer_elements_list
    layer_elements_list = [
    ]
    layer_sets['load_2'] = layer_elements_list
    return layer_sets
...
def ReadLayerNodesSets():
    ...
    layer_nodes_sets['load_1'] = layer_nodes_list
    layer_nodes_list = [
    4068 ,
    ]
    layer_nodes_sets['load_2'] = layer_nodes_list
