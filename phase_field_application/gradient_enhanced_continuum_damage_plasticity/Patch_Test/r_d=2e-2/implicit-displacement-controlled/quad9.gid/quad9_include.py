...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, GradientEnhancedDamagePlasticityRateLimitLaw() )
        ...
        self.model_part.Properties[1].SetValue(YIELD_LIMIT_FOR_DAMAGE, 2.0e-2 ) # r_d
