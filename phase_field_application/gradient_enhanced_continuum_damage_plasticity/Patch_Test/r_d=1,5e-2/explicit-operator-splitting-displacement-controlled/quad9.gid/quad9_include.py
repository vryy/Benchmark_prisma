...
class Model:
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, GradientEnhancedDamagePlasticityRateLimitOpsLaw() )
        ...
        self.model_part.Properties[1].SetValue(YIELD_LIMIT_FOR_DAMAGE, 1.5e-2 ) # r_d
        ...
        print("GradientEnhancedDamagePlasticityRateLimitOpsLaw is selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
