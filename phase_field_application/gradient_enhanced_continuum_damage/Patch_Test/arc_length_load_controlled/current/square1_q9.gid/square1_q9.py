...
def main(output=True, logging=True):
    ...
    for tmp in step_list:
        ...
        for i in range(0, nsteps):
            if first_reload:
                model.solver.solver.arc_length_control_process.SetForcedMode(1) # force move forward
                first_reload = False
            else:
                model.solver.solver.arc_length_control_process.SetForcedMode(0) # force nothing
...
def test():
    ...
    ref_reac = 2.310764673850443e+01
