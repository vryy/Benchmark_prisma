...
class Model:
    def __init__( self, problem_name, path, results_path, logging=True ):
        ...
        self.analysis_parameters['solution_strategy'] = "arc_length_displacement_control"
        self.analysis_parameters['arc_length_constraint_type'] = "cylinder-displacement"
        self.analysis_parameters['arc_length_radius'] = 1.0e-6
        ...
        self.analysis_parameters['log_lambda'] = logging
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, GradientEnhancedDamageRateLimitLaw_PlaneStrain() )
        self.model_part.Properties[1].SetValue(GRADIENT_DAMAGE_PENALIZATION, 0.1 ) # beta
        self.model_part.Properties[1].SetValue(LOCAL_NONLOCAL_DAMAGE_PENALIZATION, 1.0e1 ) # alpha
        ...
        print("GradientEnhancedDamageRateLimitLaw_PlaneStrain is selected")
        ##################################################################
        ## ACTIVATION ####################################################
        ##################################################################
