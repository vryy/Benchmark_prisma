...
class Model:
    def __init__( self, problem_name, path, results_path, logging=True ):
        ...
        self.solver.solver.convergence_criteria = DamagePlasticityCriteria(self.rel_tol, self.abs_tol)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(LOCAL_NONLOCAL_DAMAGE_PENALIZATION, 1.0e-1 ) # alpha_f
