...
##################################################################
##################################################################
sys.path.append('./abaqus_solid_necking_q4.gid')
import abaqus_solid_necking_q4_include
from abaqus_solid_necking_q4_include import *
model = abaqus_solid_necking_q4_include.Model('abaqus_solid_necking_q4',os.getcwd()+"/",os.getcwd()+"/")
...
def main(output=True,logging=True):
    ...
    for element in model.model_part.Elements:
        element.SetValuesOnIntegrationPoints(DAMAGE, f0_vec, model.model_part.ProcessInfo)
...
def test():
    ...
    for node in prescribed_nodes:
        reac_force_y += node.GetSolutionStepValue(REACTION_Y)
    ref_reac = 8.972321442498778e+03
