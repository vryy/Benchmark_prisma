...
x1, y1 = extract_data('mesh_200.gid/Disp_Reaction.txt')
#x2, y2 = extract_data('mesh_800.gid/Disp_Reaction.txt')
#x3, y3 = extract_data('mesh_1800.gid/Disp_Reaction.txt')

# print(sum_p['py'])

pylab.plot(x1, y1, label='200', marker='.')
